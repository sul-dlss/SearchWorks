...
RSpec.describe LocationRequestLinkComponent, type: :component do
  ...
  let(:items) { [instance_double(Holdings::Item, current_location: double(code: nil), circulates?: true, folio_pageable?: false)] }
  ...
  context 'when none of the items have a circulating type' do
    let(:items) { [instance_double(Holdings::Item, circulates?: false, current_location: double(code: nil), folio_pageable?: false)] }
  ...
  context 'when all items are in a mediated page location' do
    ...
    let(:items) { [instance_double(Holdings::Item, circulates?: false, current_location: double(code: nil))] }
  ...
  context 'when all items match a combination of Aeon location and item type' do
    ...
    let(:items) { [instance_double(Holdings::Item, circulates?: false, type: 'NH-INHOUSE', current_location: double(code: nil))] }
  ...
  context 'when items match an Aeon location but have the wrong item type' do
    ...
    let(:library) { 'SAL' }
    let(:location) { 'L-PAGE-EA' }
    let(:items) { [instance_double(Holdings::Item, circulates?: false, type: 'NEWSPAPER', current_location: double(code: nil), folio_pageable?: false)] }
  ...
  context 'for Hopkins items' do
    ...
    let(:library) { 'HOPKINS' }
    let(:location) { 'STACKS' }
    let(:items) { [instance_double(Holdings::Item, circulates?: true, current_location: double(code: nil))] }
