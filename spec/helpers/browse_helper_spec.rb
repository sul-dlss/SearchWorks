...
RSpec.describe BrowseHelper do
  describe "#link_to_callnumber_browse" do
    ...
    let(:item) { Holdings::Item.new({ barcode: '321', library: 'abc', effective_permanent_location_code: 'home_location', type: 'type', lopped_callnumber: 'truncated_callnumber', shelfkey: 'shelfkey', reverse_shelfkey: 'reverse_shelfkey', callnumber: 'callnumber' }) }
