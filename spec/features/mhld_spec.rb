...
RSpec.describe "MHLD", :feature do
  describe "record view" do
    it "is present in the location access panel" do
      ...
      within('.panel-library-location:has([data-location-hours-route-value="/hours/ENG"])') do
      ...
      within('.panel-library-location:has([data-location-hours-route-value="/hours/GREEN"])') do
