  ...
  describe "has SearchWorks customizations" do
    it "should display correct elements" do
      within "#search-navbar" do
        ...
        expect(page).to have_css("li.disabled a", text: "Advanced")
        expect(page).to have_css("li.disabled a", text: "Browse")
        expect(page).to have_css("li.disabled a", text: "Selections")
      end
    end
  end
end
