module AccessPanels
  class LocationItemComponent < ViewComponent::Base
    ...
    def temporary_location_text
      return if item.effective_location&.details&.key?('availabilityClass') || item.effective_location&.details&.key?('searchworksTreatTemporaryLocationAsPermanentLocation') || item.home_location == item.temporary_location_code
