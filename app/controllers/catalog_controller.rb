...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.default_solr_params = {
      ...
      :"f.stanford_theses_facet_hsim.facet.limit" => "-1"
    }
    ...
    config.add_facet_field 'stanford_theses_facet_hsim',
                            label: 'Stanford theses & dissertations',
