...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_search_field('call_number') do |field|
      ...
      field.solr_parameters = {
        qf: 'callnum_search alphanum_callnum_search spec_callnum_search sudoc_callnum_search',
        pf: 'callnum_search alphanum_callnum_search spec_callnum_search sudoc_callnum_search'
      }
    end
