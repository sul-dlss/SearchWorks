  ...
  modalHtml(title) {
    return `
      <div class="modal-header">
        ...
        <button 
          type="button" 
          class="blacklight-modal-close btn-close" 
          data-bl-dismiss="modal" 
          data-dismiss="modal" 
          aria-label="Close"
        >
        ...
        <div class="facet-pagination bottom flex-row justify-content-between">
          <div class="prev_next_links btn-group pull-left">
            <button 
              class="btn btn-link" 
              disabled 
              data-articles-facet-paginate-target="prev" 
              data-action="articles-facet-paginate#previous"
            >
              <i class="fa fa-arrow-left"></i> <span class="d-none d-sm-inline">Previous</span>
            </button>
            <button 
              class="btn btn-link" 
              data-articles-facet-paginate-target="next" 
              data-action="articles-facet-paginate#next"
            >
              <span class="d-none d-sm-inline">Next</span> <i class="fa fa-arrow-right"></i>
            </button>
          </div>
