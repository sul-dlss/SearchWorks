      ...
      <div class="modal-footer">
        <div class="facet-pagination bottom flex-row justify-content-between">
          <div class="prev_next_links btn-group pull-left">
            <button class="btn btn-link" data-articles-facet-paginate-target="prev" data-action="articles-facet-paginate#previous"><i class="fa fa-arrow-left"></i> <span class="d-none d-sm-inline">Previous</span></a>
