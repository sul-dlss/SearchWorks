...
module RisMapping
  ...
  def searchworks_url
    url = Rails.application.routes.url_helpers.solr_document_url(fetch('id'), host: 'https://searchworks.stanford.edu')
    "<a aria-label='Permanent link to item' href='#{url}'>#{url}</a>" \
  end
