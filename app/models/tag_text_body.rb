...
# a generic model for tag bodies that have ContentAsText, with the RDF Repository set.
#
...
# 
# The triple store in scope for *this* TagTextBody model is a simple in-memory RDF Repository;  
