...
set :linked_files, %w{config/database.yml config/blacklight.yml config/honeybadger.yml config/newrelic.yml config/secrets.yml public/robots.txt config/locales/alerts.en.yml}
